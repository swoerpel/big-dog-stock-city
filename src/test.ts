...
let sum = 0;
let numbers = [1,5,3,4,5,7,3]


// add all these numbers together without a for loop

// add all these numbers together WITH a for loop
...
const grandpasAge = 70;

const updatedAge = updateAge(grandpasAge)
